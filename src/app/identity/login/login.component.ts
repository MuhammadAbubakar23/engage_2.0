...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    private sendActorsService : ActorsInfoService
  ) {}
    ...
    this.authService.login(obj).subscribe(
      (res: any) => {
        if (res.isTwoFAEnabled == false) {
          ...
          //   this.sendActorsService.sendActors(this.loginResponse?.actors)
          // } else{
            try {
              this.commonService.UserLogin().subscribe(() => {
                ...
                this.commonService.GetSkills(res?.loginResponse?.loginResponse?.skills)
