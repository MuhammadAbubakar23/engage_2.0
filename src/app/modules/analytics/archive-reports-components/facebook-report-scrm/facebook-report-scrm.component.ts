...
@Component({
  standalone:true,
  selector: 'app-facebook-report-scrm',
  templateUrl: './facebook-report-scrm.component.html',
  styleUrls: ['./facebook-report-scrm.component.scss'],
  imports:[CommonModule,ReactiveFormsModule,FormsModule]
})
export class FacebookReportScrmComponent implements OnInit {
startDate:string=''
endDate:string=''
currentDate:any
maxEndDate:any
...
this.maxEndDate=this.currentDate.toISOString().split('T')[0] 
 ...
 this.getPublishinbehaviorGraph()
 this.getAudienceGrowthGraph()
 this.getAudinceEngagementGraph()
 this.getPeopleWhoViewdGraph()
 this.getReactionGraph()
 this.getPageReachablityGraph()
 this.getExternalSourcesGraph()
 this.getAllDataScrmFacebookReport()
 this.GetFortestingSCRM()
  }
  getAllDataScrmFacebookReport(){
