...
export const environment = {
  ...
  DemoWhatsappBaseUrl: 'https://enwhatsappbackend.enteract.live/api/',
  DemoLinkdinBaseUrl: 'https://enlinkedinbackend.enteract.live/api/',
  DemoExchangeEmailBaseUrl: 'https://enexchangebackend.enteract.live/api/',


  // For page connections of Stagging
  ...
  InstagramBaseUrl: 'https://smallyellowkayak87.conveyor.cloud/api/', // https://insta.360scrm.com
  LinkdinBaseUrl: '',
  GSuitBaseUrl: 'https://mail.360scrm.com/api/',
  PlayStoreBaseUrl: 'https://play.360scrm.com/api/',
  ExchangeEmailBaseUrl: '',
